...
class BamlSyncClient:
    ...
    def ChatCached(self, document: str,history: typing.List["types.Message"],question: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ChatCached", args={
    ...
    def ChatUncached(self, document: str,history: typing.List["types.Message"],question: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ChatUncached", args={
                "document": document,"history": history,"question": question,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ChatCached(self, document: str,history: typing.List["types.Message"],question: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ChatCached", args={
            "document": document,"history": history,"question": question,
        })
    ...
    def ChatUncached(self, document: str,history: typing.List["types.Message"],question: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ChatUncached", args={
            "document": document,"history": history,"question": question,
        })
        return baml_py.BamlSyncStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ChatCached(self, document: str,history: typing.List["types.Message"],question: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ChatCached", args={
            "document": document,"history": history,"question": question,
        }, mode="request")
        return __result__
    def ChatUncached(self, document: str,history: typing.List["types.Message"],question: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ChatUncached", args={
            "document": document,"history": history,"question": question,
        }, mode="request")
        return __result__
    def ExtractResume(self, resume: str,
