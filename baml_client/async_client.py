...
class BamlAsyncClient:
    ...
    async def ChatCached(self, document: str,history: typing.List["types.Message"],question: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ChatCached(document=document,history=history,question=question,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ChatCached", args={
    ...
    async def ChatUncached(self, document: str,history: typing.List["types.Message"],question: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ChatUncached(document=document,history=history,question=question,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ChatUncached", args={
                "document": document,"history": history,"question": question,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ChatCached(self, document: str,history: typing.List["types.Message"],question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ChatCached", args={
            "document": document,"history": history,"question": question,
        })
    ...
    def ChatUncached(self, document: str,history: typing.List["types.Message"],question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ChatUncached", args={
            "document": document,"history": history,"question": question,
        })
        return baml_py.BamlStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def ChatCached(self, document: str,history: typing.List["types.Message"],question: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ChatCached", args={
            "document": document,"history": history,"question": question,
        }, mode="request")
        return __result__
    async def ChatUncached(self, document: str,history: typing.List["types.Message"],question: str,
